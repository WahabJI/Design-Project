...
describe('QuoteHistory', () => {
    ...
    it('should render correctly', async () => {
      //mock the fetch call
      fetch.mockResponseOnce(JSON.stringify({date: '2022-01-01', address_1: '3551 Cullen Blvd', address_2: 'Rm563', city: 'Houston', state: 'TX', zipCode: 77004, gallons: 100, pricePerGallon: 2.50, totalCost: 250 },
