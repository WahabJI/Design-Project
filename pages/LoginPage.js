        ...
        <div className="flex min-h-screen">
          <div className="px-8 py-6 text-left bg-white shadow-lg m-auto">
            ...
            <form action="" onSubmit={handleSubmit}>
              ...
              <div className="flex justify-center items-center mt-4">
                <button onClick={HandleGoogleSignIn} type="button" className="w-full px-4 py-2 mt-2 text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2">
